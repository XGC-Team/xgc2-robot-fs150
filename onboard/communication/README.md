...
Install `xgc2-fs150-mavlink-router` to install the communication and
MAVROS units owned by `onboard/autostart`. The package does not enable
or start them. The aggregator package `xgc2-fs150` also does not start
them.
